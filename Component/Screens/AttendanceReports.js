...
export default function AttendanceReports({ navigation }) {
  ...
  // DropDownPicker requires open/value/items + setters
  ...
  // Prevent DropDownPicker from overlapping the bottom nav on Android
  useEffect(() => {
    return () => {
      // cleanup if needed
    };
  ...
  const onChangeDate = (event, selectedDate) => {
    // On iOS selectedDate can be undefined when dismissed
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Attendance counts for the selected date (static for now) */}
      <View style={styles.summaryContainer}>
        <View style={styles.card}>
